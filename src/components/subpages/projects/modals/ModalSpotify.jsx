...
const ModalSpotify = ({ open, onClose }) => {
  ...
  return (
    <div
      className={
        "w-[90%] h-[80%] md:w-[70%] lg:max-w-4xl md:max-h-[1000px] bg-slate-700 z-10 fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 rounded-2xl overflow-clip"
      }
    >
